...
import com.users.dao.po.RoleExample.Criteria;
import com.users.dao.po.RoleExample.Criterion;
...
public class RoleSqlProvider {
    ...
    public String insertSelective(Role record) {
        ...
        if (record.getRoleDescribe() != null) {
            sql.VALUES("role_describe", "#{roleDescribe,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRoleDescribe() != null) {
            sql.SET("role_describe = #{record.roleDescribe,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Role record) {
        ...
        if (record.getRoleDescribe() != null) {
            sql.SET("role_describe = #{roleDescribe,jdbcType=VARCHAR}");
        }
