...
import com.users.dao.po.PermissionExample.Criteria;
import com.users.dao.po.PermissionExample.Criterion;
...
public class PermissionSqlProvider {
    ...
    public String insertSelective(Permission record) {
        ...
        if (record.getPermissionDescribe() != null) {
            sql.VALUES("permission_describe", "#{permissionDescribe,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(PermissionExample example) {
        ...
        sql.SELECT("permission_describe");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPermissionDescribe() != null) {
            sql.SET("permission_describe = #{record.permissionDescribe,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Permission record) {
        ...
        if (record.getPermissionDescribe() != null) {
            sql.SET("permission_describe = #{permissionDescribe,jdbcType=VARCHAR}");
        }
