...
import com.users.dao.po.MenuExample.Criteria;
import com.users.dao.po.MenuExample.Criterion;
...
public class MenuSqlProvider {
    ...
    public String insertSelective(Menu record) {
        ...
        if (record.getMenuDescribe() != null) {
            sql.VALUES("menu_describe", "#{menuDescribe,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Menu record) {
        ...
        if (record.getMenuDescribe() != null) {
            sql.SET("menu_describe = #{menuDescribe,jdbcType=VARCHAR}");
        }
