...
import com.users.dao.po.UsersExample.Criteria;
import com.users.dao.po.UsersExample.Criterion;
...
public class UsersSqlProvider {
    ...
    public String insertSelective(Users record) {
        ...
        if (record.getUserPhonenum() != null) {
            sql.VALUES("user_phonenum", "#{userPhonenum,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getUserPhonenum() != null) {
            sql.SET("user_phonenum = #{record.userPhonenum,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Users record) {
        ...
        if (record.getUserPhonenum() != null) {
            sql.SET("user_phonenum = #{userPhonenum,jdbcType=VARCHAR}");
        }
