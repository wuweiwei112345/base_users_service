...
import com.users.dao.po.FileExample.Criteria;
import com.users.dao.po.FileExample.Criterion;
...
public class FileSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getFileId() != null) {
            sql.SET("file_id = #{record.fileId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(File record) {
        ...
        sql.WHERE("file_id = #{fileId,jdbcType=INTEGER}");
